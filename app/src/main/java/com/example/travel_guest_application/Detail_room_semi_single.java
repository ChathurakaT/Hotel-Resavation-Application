...
public class Detail_room_semi_single extends AppCompatActivity {

    Button book_btn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detail_room_semi_single);
        ...
        book_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivities(new Intent[]{new Intent(Detail_room_semi_single.this, information_form.class)});
            }
        });
    }
